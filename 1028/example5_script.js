...
agreeBtn.addEventListener('mousedown', (event) => {
  if (!agreeBtn.dataset.confirmed) { 
    event.preventDefault(); 
    const confirmed = confirm("這是隱私條款內容，請確認您已閱讀。");
    if (confirmed) {
      agreeBtn.dataset.confirmed = 'true';
